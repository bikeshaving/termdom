...
use to hide a fixture. CSSOM belongs to the engine, not to the tree.

- Test files in the suites: 210
- Reference tests (no testharness, scored by pixels): 3
- Excluded, each with its reason below: 45
- Files whose harness completed: 157
- Files whose harness did not complete: 5
- Subtests passed: 9310
- Subtests failed: 353
...
| dom/nodes/MutationObserver-attributes.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-callback-arguments.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-characterData.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-childList.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-cross-realm-callback-report-exception.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-disconnect.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-document.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-inner-outer.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-sanity.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-takeRecords.html | later-phase: MutationObserver |
| dom/nodes/MutationObserver-textContent.html | later-phase: MutationObserver |
...
### dom/nodes/Node-cloneNode.html, Document-createElement.html, Document-getElementById.html, DOMImplementation-createHTMLDocument.html, Node-properties.html
...
createEvent constructs Event and CustomEvent, and throws NotSupportedError for every other name. The interfaces the rest of the table names -- UIEvent, MouseEvent, KeyboardEvent and the others -- are UI Events, a later phase; a createEvent that returned a bare Event under those names would be a lie about what it built.
...
| dom/nodes/MutationObserver-attributes.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-callback-arguments.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-characterData.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-childList.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-cross-realm-callback-report-exception.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-disconnect.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-document.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-inner-outer.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-sanity.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-takeRecords.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
| dom/nodes/MutationObserver-textContent.html | EXCLUDED (later-phase: MutationObserver) | 0 | 0 |
...
| dom/nodes/ParentNode-replaceChildren.html | OK | 27 | 4 |
