...
- Reference tests (no testharness, scored by pixels): 43
- Excluded, each with its reason below: 573
- Files whose harness completed: 475
- Files whose harness did not complete: 68
- Subtests passed: 94090
- Subtests failed: 2012
...
| selection/deleteFromDocument-HTMLDetails.html | requires-browsing-context: the fixture is built in one iframe and compared against a reference document in another |
...
| selection/bidi/modify.tentative.html | ERROR | 0 | 36 |
...
| selection/contenteditable/modify-around-non-editable-span.html | TIMEOUT | 0 | 0 |
| selection/contenteditable/modify.tentative.html | ERROR | 0 | 15 |
...
| selection/deleteFromDocument-HTMLDetails.html | EXCLUDED (requires-browsing-context: the fixture is built in one iframe and compared against a reference document in another) | 0 | 0 |
...
| selection/selection-range-after-editinghost-removed.html | OK | 0 | 4 |
...
| selection/textcontrols/selectionchange-bubble.html | OK | 0 | 4 |
| selection/textcontrols/selectionchange-on-shadow-dom.html | OK | 0 | 1 |
| selection/textcontrols/selectionchange.html | OK | 0 | 60 |
...
- basic with click(): input.click is not a function
...
- disabled checkbox still has activation behavior: child.click is not a function
- disabled checkbox still has activation behavior, part 2: checkbox.click is not a function
- disabled radio still has activation behavior: radio.click is not a function
- disconnected checkbox should be checked: input.click is not a function
- disconnected radio should be checked: input.click is not a function
...
- disabling checkbox in onclick listener shouldn't suppress oninput: input.click is not a function
- disabling checkbox in onclick listener shouldn't suppress onchange: input.click is not a function
- disabling radio in onclick listener shouldn't suppress oninput: input.click is not a function
- disabling radio in onclick listener shouldn't suppress onchange: input.click is not a function
- disconnected form should not submit: input.click is not a function
...
- submit button that morphed from checkbox should not activate: input.click is not a function

### dom/events/Event-dispatch-click.tentative.html

- disabled checkbox should not be checked from label click: label.click is not a function
- disabled radio should not be checked from label click: label.click is not a function
...
- detached checkbox should not emit input or change events on click().: input.click is not a function
- detached radio should not emit input or change events on click().: input.click is not a function
...
- attached checkbox should emit input and change events on click().: input.click is not a function
- attached radio should emit input and change events on click().: input.click is not a function
...
- attached to shadow dom checkbox should emit input and change events on click().: input.click is not a function
- attached to shadow dom radio should emit input and change events on click().: input.click is not a function
...
- Calling click() on disabled elements must not dispatch events.: elem.click is not a function
...
- When clicking child <INPUT></INPUT> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
...
- When clicking child <INPUT></INPUT> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <INPUT></INPUT> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
...
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><INPUT></INPUT></FORM> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
...
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <FORM><BUTTON></BUTTON></FORM> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <A></A> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <AREA></AREA> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <DETAILS><SUMMARY></SUMMARY></DETAILS> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL> of parent <LABEL><BUTTON></BUTTON></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <INPUT></INPUT>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <FORM><INPUT></INPUT></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <FORM><BUTTON></BUTTON></FORM>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <A></A>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <AREA></AREA>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <DETAILS><SUMMARY></SUMMARY></DETAILS>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
- When clicking child <LABEL><BUTTON></BUTTON></LABEL> of parent <LABEL><INPUT></INPUT><SPAN></SPAN></LABEL>, only child should be activated.: promise_test: Unhandled rejection with value: object "TypeError: getClickTarget(...).click is not a function"
...
- Constructed FocusEvent timestamp should be high resolution and have the same time origin as performance.now(): window[eventType] is not a constructor
...
- disabled is honored properly in presence of dynamic changes: e.click is not a function

### dom/events/label-default-action.html

- Label default action should not trigger when clicked button removes itself: button.click is not a function
...
- behavior of preventDefault during activation behavior: promise_test: Unhandled rejection with value: object "TypeError: button.click is not a function"
...
- setBaseAndExtent(use, 0, circle, 0) in "<svg><use><circle></circle></use></svg>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(use, 1, circle, 0) in "<svg><use>\n<circle></circle></use></svg>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(circle, 0, use, 1) in "<svg><use><circle></circle></use></svg>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 0, summary, 0) in "<details><summary>ABC</summary>DEF</details>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 1, summary, 0) in "<details>\n<summary>ABC</summary>DEF</details>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 0, summary > #text, 0) in "<details><summary>ABC</summary>DEF</details>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 0, summary + #text, 0) in "<details><summary>ABC</summary>DEF</details>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 1, summary + #text, 0) in "<details>\n<summary>ABC</summary>DEF</details>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 0, p+p, 0) in "<details><summary>ABC</summary><p>DEF</p><p>GHI</p></details>": document.body.getBoundingClientRect is not a function
- setBaseAndExtent(details, 1, p+p, 0) in "<details>\n<summary>ABC</summary><p>DEF</p><p>GHI</p></details>": document.body.getBoundingClientRect is not a function
...
- undefined with left direction in ltr context: selection.modify is not a function
- undefined with left direction in ltr context: selection.modify is not a function
- undefined with left direction in ltr context: selection.modify is not a function
- undefined with left direction in ltr context: selection.modify is not a function
- undefined with left direction in ltr context: selection.modify is not a function
- undefined with left direction in ltr context: selection.modify is not a function
- undefined with right direction in ltr context: selection.modify is not a function
- undefined with right direction in ltr context: selection.modify is not a function
- undefined with right direction in ltr context: selection.modify is not a function
- undefined with right direction in ltr context: selection.modify is not a function
- undefined with right direction in ltr context: selection.modify is not a function
- undefined with right direction in ltr context: selection.modify is not a function
- undefined with left direction in rtl context: selection.modify is not a function
- undefined with left direction in rtl context: selection.modify is not a function
- undefined with left direction in rtl context: selection.modify is not a function
- undefined with left direction in rtl context: selection.modify is not a function
- undefined with left direction in rtl context: selection.modify is not a function
- undefined with left direction in rtl context: selection.modify is not a function
- undefined with right direction in rtl context: selection.modify is not a function
- undefined with right direction in rtl context: selection.modify is not a function
- undefined with right direction in rtl context: selection.modify is not a function
- undefined with right direction in rtl context: selection.modify is not a function
- undefined with right direction in rtl context: selection.modify is not a function
- undefined with right direction in rtl context: selection.modify is not a function
- undefined with left direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with left direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with left direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with left direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with left direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with left direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with right direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with right direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with right direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with right direction in ltr context (which was previously rtl): selection.modify is not a function
- undefined with right direction in ltr context (which was previously rtl): selection.modify is not a function
...
- Caret position should be correct in moving up horizontal div when selection was left to right with line granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving up horizontal div when selection was right to left with line granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving down horizontal div when selection was left to right with line granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving down horizontal div when selection was right to left with line granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving up horizontal div when selection was left to right with paragraph granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving up horizontal div when selection was right to left with paragraph granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving down horizontal div when selection was left to right with paragraph granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in moving down horizontal div when selection was right to left with paragraph granularity: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with line granularity for vertical-lr div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with line granularity for vertical-lr div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with line granularity for vertical-lr div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with line granularity for vertical-lr div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with paragraph granularity for vertical-lr div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with paragraph granularity for vertical-lr div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with paragraph granularity for vertical-lr div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with paragraph granularity for vertical-lr div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with line granularity for vertical-rl div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with line granularity for vertical-rl div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with line granularity for vertical-rl div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with line granularity for vertical-rl div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with paragraph granularity for vertical-rl div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move left with paragraph granularity for vertical-rl div when selection was bottom to top: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with paragraph granularity for vertical-rl div when selection was top to bottom: testData.elementUnderTest.focus is not a function
- Caret position should be correct in move right with paragraph granularity for vertical-rl div when selection was bottom to top: testData.elementUnderTest.focus is not a function

### selection/contenteditable/collapse.html

- Selection.collapse() must succeed across siblings: button.focus is not a function
- Selection.collapse() must succeed for the ancestor: button.focus is not a function
- Selection.collapse() must succeed for the descendant: button.focus is not a function

### selection/contenteditable/modify-around-inline-element-boundary.tentative.html

- Selection.modify("move", "right", "character") when "ab[]c<span>def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "abc[]<span>def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "<b>ab[]c</b><i>def</i>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "<b>abc[]</b><i>def</i>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc<span>d[]ef</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc<span>[]def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "<b>abc</b><i>d[]ef</i>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "<b>abc</b><i>[]def</i>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "abc[] <span>def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "abc[]<span> def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc <span>[]def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc<span> []def</span>": Cannot read properties of null (reading 'test_driver')
...
- Selection.modify("move", "right", "character") when "abc[] <span> def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "abc[]<span>  def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "<span>abc[]  </span>def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "<span>abc[] </span> def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") when "<span>abc[]</span>  def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc  <span>[]def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc <span> []def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "abc<span>  []def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "<span>abc  </span>[]def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "<span>abc </span> []def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") when "<span>abc</span>  []def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") (2 times) when "abc[]  <span>def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") (2 times) when "abc[] <span> def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") (2 times) when "abc[]<span>  def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") (2 times) when "<span>abc[]  </span>def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") (2 times) when "<span>abc[] </span> def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "right", "character") (2 times) when "<span>abc[]</span>  def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") (2 times) when "abc  <span>[]def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") (2 times) when "abc <span> []def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") (2 times) when "abc<span>  []def</span>": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") (2 times) when "<span>abc  </span>[]def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") (2 times) when "<span>abc </span> []def": Cannot read properties of null (reading 'test_driver')
- Selection.modify("move", "left", "character") (2 times) when "<span>abc</span>  []def": Cannot read properties of null (reading 'test_driver')
...
- Selection.modify('move', 'forward', 'lineboundary') must be within the inline editing host: undefined: selection.modify is not a function
- Selection.modify('move', 'backward', 'lineboundary') must be within the inline editing host: undefined: selection.modify is not a function
- Selection.modify('move', 'forward', 'lineboundary') must be within the inline editing host: undefined: selection.modify is not a function
- Selection.modify('move', 'backward', 'lineboundary') must be within the inline editing host: undefined: selection.modify is not a function
- Selection.modify('move', 'forward', 'lineboundary') must be within the inline editing host: undefined: selection.modify is not a function
- Selection.modify('move', 'backward', 'lineboundary') must be within the inline editing host: undefined: selection.modify is not a function
...
- selectionchange event fired on the document in case TextControl element is in Shadow Tree: promise_test: Unhandled rejection with value: object "TypeError: element.focus is not a function"
...
- Set selection range into a sub-document with selectNode: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with selectNodeContents: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with setEnd: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with setEndAfter: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with setEndBefore: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with setStart: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with setStartAfter: Cannot read properties of undefined (reading 'getElementById')
- Set selection range into a sub-document with setStartBefore: Cannot read properties of undefined (reading 'getElementById')

### selection/onselectionchange-on-distinct-text-controls.html

- selectionchange event on each input element fires independently: promise_test: Unhandled rejection with value: object "TypeError: input1.setSelectionRange is not a function"
- selectionchange event on each textarea element fires independently: promise_test: Unhandled rejection with value: object "TypeError: textarea1.setSelectionRange is not a function"
...
### selection/selection-range-after-editinghost-removed.html

- Selection range in an editing host should be collapsed where the host was after it's removed: editingHost.focus is not a function
- Selection range in an editing host should be collapsed where the host was after its parent is removed: editingHost.focus is not a function
- Selection range in an editing host should be collapsed where the host was after it's replaced with itself (.replaceWith): editingHost.focus is not a function
- Selection range in an editing host should be collapsed where the host was after it's replaced with itself (.replaceChild): editingHost.focus is not a function
...
- selectionchange bubbles from input: promise_test: Unhandled rejection with value: object "TypeError: element.setSelectionRange is not a function"
- selectionchange bubbles from input when focused: promise_test: Unhandled rejection with value: object "TypeError: element.focus is not a function"
- selectionchange bubbles from textarea: promise_test: Unhandled rejection with value: object "TypeError: element.setSelectionRange is not a function"
- selectionchange bubbles from textarea when focused: promise_test: Unhandled rejection with value: object "TypeError: element.focus is not a function"

### selection/textcontrols/selectionchange-on-shadow-dom.html

- selectionchange event fired on a shadow dom bubble to the document: promise_test: Unhandled rejection with value: object "TypeError: input.focus is not a function"

### selection/textcontrols/selectionchange.html

- Modifying selectionStart value of the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionEnd value of the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setSelectionRange() on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionStart value on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionStart value twice on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionEnd value on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionEnd value twice on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selection range on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selection range twice on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() twice on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() after select() on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() repeatedly on the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on empty the input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionStart value of the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionEnd value of the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setSelectionRange() on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionStart value on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionStart value twice on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionEnd value on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionEnd value twice on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selection range on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selection range twice on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() twice on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() after select() on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() repeatedly on the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on empty the disconnected input element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionStart value of the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionEnd value of the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setSelectionRange() on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionStart value on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionStart value twice on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionEnd value on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionEnd value twice on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selection range on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selection range twice on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() twice on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() after select() on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() repeatedly on the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on empty the textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionStart value of the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Modifying selectionEnd value of the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setSelectionRange() on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionStart value on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionStart value twice on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selectionEnd value on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selectionEnd value twice on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting initial zero selection range on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Setting the same selection range twice on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling select() twice on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() after select() on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() repeatedly on the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
- Calling setRangeText() on empty the disconnected textarea element: promise_test: Unhandled rejection with value: object "TypeError: collector.target.blur is not a function"
...
- document.caretPositionFromPoint() should return a CaretPosition at the specified location: container.firstChild.getBoundingClientRect is not a function
- document.caretPositionFromPoint() should return a CaretPosition at the specified location pointing to an input element which is the offsetNode.: container.firstChild.getBoundingClientRect is not a function
...
- document.elementFromPoint and shadow.ElementFromPoint must return the shadow host of the hit-tested text node when the hit-tested text node is a direct child of the root and the host has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint and shadow.ElementFromPoint must return the shadow host of the hit-tested text node when the hit-tested text node is a direct child of the root and the host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint and shadow.ElementFromPoint must return the shadow host of the hit-tested text node when the hit-tested text node is a direct child of the root and the host has display: inline-block: document.elementFromPoint is not a function
- document.elementFromPoint and shadowRoot.elementFromPoint must return the shadow host when the hit-tested text node is assigned to a slot and the host has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint and shadowRoot.elementFromPoint must return the shadow host when the hit-tested text node is assigned to a slot and the host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint and shadowRoot.elementFromPoint must return the shadow host when the hit-tested text node is assigned to a slot and the host has display: inline-block: document.elementFromPoint is not a function
- document.elementFromPoint and shadowRoot.elementFromPoint must return the element assigned to a slot when hit-tested text node under an element is assigned to a slot in the shadow tree and the shadow host of the slot has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint and shadowRoot.elementFromPoint must return the element assigned to a slot when hit-tested text node under an element is assigned to a slot in the shadow tree and the shadow host of the slot has display: block: document.elementFromPoint is not a function
- document.elementFromPoint and shadowRoot.elementFromPoint must return the element assigned to a slot when hit-tested text node under an element is assigned to a slot in the shadow tree and the shadow host of the slot has display: inline-block: document.elementFromPoint is not a function
- document.elementFromPoint must return the shadow host of the hit-tested element under a shadow root and shadowRoot.elementFromPoint must return the element parent of the hit-tested text node under the point when the shadow host has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint must return the shadow host of the hit-tested element under a shadow root and shadowRoot.elementFromPoint must return the element parent of the hit-tested text node under the point when the shadow host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint must return the shadow host of the hit-tested element under a shadow root and shadowRoot.elementFromPoint must return the element parent of the hit-tested text node under the point when the shadow host has display: inline-block: document.elementFromPoint is not a function
- document.elementFromPoint must return the shadow host and shadowRoot.elementFromPoint must return the slot parent of the fallback text when the hit-tested text node is a fallback content and the host has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint must return the shadow host and shadowRoot.elementFromPoint must return the slot parent of the fallback text when the hit-tested text node is a fallback content and the host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint must return the shadow host and shadowRoot.elementFromPoint must return the slot parent of the fallback text when the hit-tested text node is a fallback content and the host has display: inline-block: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint, innerShadow.elementFromPoint must return a child element assigned to a slot when the hit-tested text node is assigned to a slot in the shadow tree of the child element and the outer shadow host has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint, innerShadow.elementFromPoint must return a child element assigned to a slot when the hit-tested text node is assigned to a slot in the shadow tree of the child element and the outer shadow host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint, innerShadow.elementFromPoint must return a child element assigned to a slot when the hit-tested text node is assigned to a slot in the shadow tree of the child element and the outer shadow host has display: inline-block: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint, innerShadow.elementFromPoint must return a child element with its own shadow tree assigned to a slot when the hit-tested text node is its direct child and the outer shadow host has display: inline: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint, innerShadow.elementFromPoint must return a child element with its own shadow tree assigned to a slot when the hit-tested text node is its direct child and the outer shadow host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint, innerShadow.elementFromPoint must return a child element with its own shadow tree assigned to a slot when the hit-tested text node is its direct child and the outer shadow host has display: inline-block: document.elementFromPoint is not a function
...
- document.elementFromPoint, shadowRoot.elementFromPoint must return a child element with its own shadow tree assigned to a slot when the hit-tested text node is a child of another element and innerShadow.elementFromPoint must return the parent element of the hit-tested text node under it when the outer shadow host has display: block: document.elementFromPoint is not a function
- document.elementFromPoint, shadowRoot.elementFromPoint must return a child element with its own shadow tree assigned to a slot when the hit-tested text node is a child of another element and innerShadow.elementFromPoint must return the parent element of the hit-tested text node under it when the outer shadow host has display: inline-block: document.elementFromPoint is not a function
- document.elementsFromPoint and shadow.elementsFromPoint must return the shadow host and its ancestors of the hit-tested text node when the hit-tested text node is a direct child of the root and the host has display: inline: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadow.elementsFromPoint must return the shadow host and its ancestors of the hit-tested text node when the hit-tested text node is a direct child of the root and the host has display: block: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadow.elementsFromPoint must return the shadow host and its ancestors of the hit-tested text node when the hit-tested text node is a direct child of the root and the host has display: inline-block: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadowRoot.elementsFromPoint must return the shadow host and its ancestors when the hit-tested text node is assigned to a slot and the host has display: inline: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadowRoot.elementsFromPoint must return the shadow host and its ancestors when the hit-tested text node is assigned to a slot and the host has display: block: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadowRoot.elementsFromPoint must return the shadow host and its ancestors when the hit-tested text node is assigned to a slot and the host has display: inline-block: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadowRoot.elementsFromPoint must return the element assigned to a slot and its non-shadow ancestors when hit-tested text node under an element is assigned to a slot in the shadow tree and the shadow host of the slot has display: inline: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadowRoot.elementsFromPoint must return the element assigned to a slot and its non-shadow ancestors when hit-tested text node under an element is assigned to a slot in the shadow tree and the shadow host of the slot has display: block: document.elementsFromPoint is not a function
- document.elementsFromPoint and shadowRoot.elementsFromPoint must return the element assigned to a slot and its non-shadow ancestors when hit-tested text node under an element is assigned to a slot in the shadow tree and the shadow host of the slot has display: inline-block: document.elementsFromPoint is not a function
- document.elementsFromPoint must return the shadow host and its ancestors of the hit-tested element under a shadow root andshadowRoot.elementsFromPoint must return the element parent and its non-shadow ancestors of the hit-tested text node under the point when the shadow host has display: inline: document.elementsFromPoint is not a function
- document.elementsFromPoint must return the shadow host and its ancestors of the hit-tested element under a shadow root andshadowRoot.elementsFromPoint must return the element parent and its non-shadow ancestors of the hit-tested text node under the point when the shadow host has display: block: document.elementsFromPoint is not a function
- document.elementsFromPoint must return the shadow host and its ancestors of the hit-tested element under a shadow root andshadowRoot.elementsFromPoint must return the element parent and its non-shadow ancestors of the hit-tested text node under the point when the shadow host has display: inline-block: document.elementsFromPoint is not a function
- document.elementsFromPoint must return the shadow host and its ancestors and shadowRoot.elementsFromPoint must return the slot parent of the fallback text and its non-shadow ancestors when the hit-tested text node is a fallback content and the host has display: inline: document.elementsFromPoint is not a function
- document.elementsFromPoint must return the shadow host and its ancestors and shadowRoot.elementsFromPoint must return the slot parent of the fallback text and its non-shadow ancestors when the hit-tested text node is a fallback content and the host has display: block: document.elementsFromPoint is not a function
- document.elementsFromPoint must return the shadow host and its ancestors and shadowRoot.elementsFromPoint must return the slot parent of the fallback text and its non-shadow ancestors when the hit-tested text node is a fallback content and the host has display: inline-block: document.elementsFromPoint is not a function
...
- CSS.highlights.highlightsFromPoint() doesn't return Highlights that are not painted at the given coordinates even when they fall inside the Highlights' ranges: spanInShadowDOM.getBoundingClientRect is not a function
...
- Elements in a shadow tree should not be accessible from owner document's getElementsByName() method.: doc.getElementsByName is not a function
...
- ariaErrorMessageElement is not defined in ElementInternals: Cannot use 'in' operator to search for 'ariaErrorMessageElement' in undefined
...
- Successful attachInternals() and the second call.: element.attachInternals is not a function
...
- If a custom element definition for the local name of the element doesn't exist, throw an NotSupportedError: assert_throws_dom: function "() => { builtin.attachInternals() }" threw object "TypeError: builtin.attachInternals is not a function" that is not a DOMException NotSupportedError: property "code" is equal to undefined, expected 9
...
- Getting previously-unset ARIA element reflection properties on ElementInternals should return null.: Cannot read properties of undefined (reading 'ariaActiveDescendantElement')
- Getting ARIA element reflection properties on ElementInternals should return the value that was set.: Cannot set properties of undefined (setting 'ariaActiveDescendantElement')
- Setting ARIA element reflection properties to an empty array should work as expected.: Cannot set properties of undefined (setting 'ariaControlsElements')
- Reading an ARIA element reflection array property that was set to an empty array, on an ElementInternals with no previously cached value, should return an empty array.: Cannot set properties of undefined (setting 'ariaControlsElements')
- Setting ARIA element reflection properties on ElementInternals to null should delete any previous value, and not crash: Cannot set properties of undefined (setting 'ariaActiveDescendantElement')
- Setting ariaLabelledByElements on ElementInternals should change the accessible name of the custom element: promise_test: Unhandled rejection with value: object "TypeError: Cannot set properties of undefined (setting 'ariaLabelledByElements')"
- Setting aria-labelledby or ariaLabelledByElements on the custom element should supersede the value of ariaLabelledByElements on ElementInternals: promise_test: Unhandled rejection with value: object "TypeError: Cannot set properties of undefined (setting 'ariaLabelledByElements')"
- Caching invariant different attributes.: Cannot set properties of undefined (setting 'ariaControlsElements')
- Caching invariant different elements.: Cannot set properties of undefined (setting 'ariaDescribedByElements')

### custom-elements/element-internals-behaviors.tentative.html

- attachInternals({ behaviors: [] }) accepts empty behaviors array: element.attachInternals is not a function
- behaviors returns empty array when no behaviors configured: element.attachInternals is not a function
...
- ElementInternals cannot be called before constructor, upgrade case: assert_throws_dom: attachInternals cannot be called before definition exists function "() => element.attachInternals()" threw object "TypeError: element.attachInternals is not a function" that is not a DOMException NotSupportedError: property "code" is equal to undefined, expected 9
- ElementInternals *can* be called after constructor, upgrade case: assert_throws_dom: attachInternals cannot be called before constructor function "() => element.attachInternals()" threw object "TypeError: element.attachInternals is not a function" that is not a DOMException NotSupportedError: property "code" is equal to undefined, expected 9
- ElementInternals cannot be called after constructor calls it, create case: assert_true: expected true got false
- ElementInternals disabled by disabledFeatures: assert_throws_dom: attachInternals forbidden by disabledFeatures, pre-upgrade function "() => element.attachInternals()" threw object "TypeError: element.attachInternals is not a function" that is not a DOMException NotSupportedError: property "code" is equal to undefined, expected 9
...
- setter on DOMStringMap must enqueue an attributeChanged reaction when adding an observed data attribute: Cannot set properties of undefined (setting 'foo')
- setter on DOMStringMap must not enqueue an attributeChanged reaction when adding an unobserved data attribute: Cannot set properties of undefined (setting 'foo')
- setter on DOMStringMap must enqueue an attributeChanged reaction when mutating the value of an observed data attribute: Cannot set properties of undefined (setting 'foo')
- setter on DOMStringMap must enqueue an attributeChanged reaction when mutating the value of an observed data attribute to the same value: Cannot set properties of undefined (setting 'foo')
- setter on DOMStringMap must not enqueue an attributeChanged reaction when mutating the value of an unobserved data attribute: Cannot set properties of undefined (setting 'foo')
- deleter on DOMStringMap must enqueue an attributeChanged reaction when removing an observed data attribute: Cannot set properties of undefined (setting 'foo')
- deleter on DOMStringMap must not enqueue an attributeChanged reaction when removing an unobserved data attribute: Cannot set properties of undefined (setting 'foo')
- deleter on DOMStringMap must not enqueue an attributeChanged reaction when it does not remove a data attribute: Cannot convert undefined or null to object
...
- createContextualFragment on Range must construct a custom element: range.createContextualFragment is not a function
...
- initialize throws when the registry scoped is false and the root document already has another registry: registry.initialize is not a function
...
- initialize sets registry on shadow root descendants with no registry: registry.initialize is not a function

### custom-elements/registries/CustomElementRegistry-upgrade.html

- upgrade is a no-op when called on a shadow root with no association: Cannot read properties of undefined (reading 'shadowRoot')
- upgrade is a no-op when called on an element associated with a different registry: Cannot read properties of null (reading 'customElements')
- upgrade should upgrade a candidate element when called on a shadow root with an association: Cannot read properties of undefined (reading 'shadowRoot')
- upgrade should not upgrade a candidate element not associated with a registry: Cannot read properties of undefined (reading 'shadowRoot')
...
- customElementRegistry on a document of a connected iframe should return contentWindow.customElements: Cannot read properties of undefined (reading 'customElementRegistry')
- customElementRegistry on a document of a disconnected iframe should return contentWindow.customElements: Cannot read properties of undefined (reading 'customElements')
...
- importNode should clone a template content using the global registry by default: Cannot read properties of null (reading '__proto__')
- importNode should clone a template content using a specified scoped registry: Cannot read properties of null (reading '__proto__')
- importNode should clone a template content with a nested template element using a scoped registry: Cannot read properties of null (reading '__proto__')
...
- customElementRegistry on a failed custom element created by parser should return the specified custom regsitry: Cannot read properties of undefined (reading 'open')
...
- customElementRegistry on an element inside a declarative shadow DOM with shadowrootcustomelementregistry should return the scoped registry after calling initialize: registry.initialize is not a function
...
- attachShadow() should use the null registry when the shadow host uses null registry and customElementRegistry is null: Cannot read properties of null (reading 'customElementRegistry')
...
- An element with scoped registry should not change its registry when run append out of the shadow tree.: registry1.initialize is not a function
- An element with scoped registry should not change its registry when run append into another shadow tree with different scoped registry.: registry1.initialize is not a function
...
- An element with scoped registry should not change its registry when run appendChild out of the shadow tree.: registry1.initialize is not a function
- An element with scoped registry should not change its registry when run appendChild into another shadow tree with different scoped registry.: registry1.initialize is not a function
...
- An element with scoped registry should not change its registry when run prepend out of the shadow tree.: registry1.initialize is not a function
- An element with scoped registry should not change its registry when run prepend into another shadow tree with different scoped registry.: registry1.initialize is not a function
...
- Connecting a custom element candiate in a shadow root with a scoped custom element registry has null registry by default: Cannot read properties of undefined (reading 'documentElement')
- Connecting a custom element candiate with null registry does not set the registry: Cannot read properties of undefined (reading 'documentElement')
- Connecting a custom element candiate with a scoped custom element registry does not change the registry: Cannot read properties of undefined (reading 'documentElement')
- Inserting a custom element candiate with null registry does not change the registry: Cannot read properties of undefined (reading 'documentElement')
- Inserting the shadow host of a shadow root with a scoped custom element registry does not change the registry: Cannot read properties of undefined (reading 'createElement')
- Inserting a node from another document with global registry results in the custom element registry to be set and upgraded.: Cannot read properties of undefined (reading 'HTMLElement')
...
- Inserting a node cloned from a template with null registry into a scoped shadow root should set global registry: Cannot read properties of undefined (reading 'documentElement')
- adoptNode then inserting into a scoped shadow root should preserve global registry: Cannot read properties of undefined (reading 'documentElement')
- Declarative shadow DOM without shadowrootcustomelementregistry attribute without registry initialized should gain effective global registry after adoption.: Cannot read properties of undefined (reading 'body')
- Declarative shadow DOM with shadowrootcustomelementregistry attribute without registry initialized should remain null registry after adoption.: Cannot read properties of undefined (reading 'body')
- Null registry element should gain effective global registry of global registry from its parent upon adoption.: Cannot read properties of undefined (reading 'customElements')
- Null registry element should gain effective global registry of null from its parent upon adoption.: Cannot read properties of undefined (reading 'customElements')
- Null registry element should gain effective global registry of scoped registry from its parent upon adoption.: registry.initialize is not a function
- Global registry element should gain effective global registry of scoped registry from its parent upon adoption.: registry.initialize is not a function
...
- Adding definition to scoped registry affects associated shadow roots in all iframes: Cannot read properties of undefined (reading 'body')
- Adding definition to scoped registry affects associated shadow roots in other frame trees: window.open is not a function
- Adding definition to scoped registry should not upgrade nodes in detached frames: Cannot read properties of undefined (reading 'body')
...
- Upgrade in association order across documents, then tree order in each document: Cannot read properties of undefined (reading 'body')
- Upgrade order is not affected by DOM order between child frames: Cannot read properties of undefined (reading 'body')
- Upgrade order is affected by shadow tree adoption across documents: Cannot read properties of undefined (reading 'body')
- Elements in the "owner" window of a scoped registry are not always upgraded first: Cannot read properties of undefined (reading 'body')

### custom-elements/registries/scoped-registry-effective-global-registry.html

- Null registry element with element parent without custom element registry attribute (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with element parent without custom element registry attribute (global registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with element parent without custom element registry attribute (scoped registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with declarative shadow root parent without custom element registry attribute appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with declarative shadow root parent with custom element registry attribute (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with declarative shadow root parent with custom element registry attribute (global registry) appended to new document: registry.initialize is not a function
- Null registry element with declarative shadow root parent with custom element registry attribute (scoped registry) appended to new document: registry.initialize is not a function
- Null registry element with imperative shadow root parent (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with imperative shadow root parent (global registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with imperative shadow root parent (scoped registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with element parent without custom element registry attribute (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with element parent without custom element registry attribute (global registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with element parent without custom element registry attribute (scoped registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with declarative shadow root parent without custom element registry attribute appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with declarative shadow root parent with custom element registry attribute (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with declarative shadow root parent with custom element registry attribute (global registry) appended to new document: registry.initialize is not a function
- Global registry element with declarative shadow root parent with custom element registry attribute (scoped registry) appended to new document: registry.initialize is not a function
- Global registry element with imperative shadow root parent (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with imperative shadow root parent (global registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with imperative shadow root parent (scoped registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with element parent without custom element registry attribute (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with element parent without custom element registry attribute (global registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with element parent without custom element registry attribute (scoped registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with declarative shadow root parent without custom element registry attribute appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with declarative shadow root parent with custom element registry attribute (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with declarative shadow root parent with custom element registry attribute (global registry) appended to new document: registry.initialize is not a function
- Scoped registry element with declarative shadow root parent with custom element registry attribute (scoped registry) appended to new document: registry.initialize is not a function
- Scoped registry element with imperative shadow root parent (null registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with imperative shadow root parent (global registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with imperative shadow root parent (scoped registry) appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with element parent without custom element registry attribute (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with element parent without custom element registry attribute (global registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with element parent without custom element registry attribute (scoped registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with declarative shadow root parent without custom element registry attribute adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with declarative shadow root parent with custom element registry attribute (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with declarative shadow root parent with custom element registry attribute (global registry) adopted by new document: registry.initialize is not a function
- Null registry element with declarative shadow root parent with custom element registry attribute (scoped registry) adopted by new document: registry.initialize is not a function
- Null registry element with imperative shadow root parent (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with imperative shadow root parent (global registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with imperative shadow root parent (scoped registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with element parent without custom element registry attribute (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with element parent without custom element registry attribute (global registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with element parent without custom element registry attribute (scoped registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with declarative shadow root parent without custom element registry attribute adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with declarative shadow root parent with custom element registry attribute (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with declarative shadow root parent with custom element registry attribute (global registry) adopted by new document: registry.initialize is not a function
- Global registry element with declarative shadow root parent with custom element registry attribute (scoped registry) adopted by new document: registry.initialize is not a function
- Global registry element with imperative shadow root parent (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with imperative shadow root parent (global registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with imperative shadow root parent (scoped registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with element parent without custom element registry attribute (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with element parent without custom element registry attribute (global registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with element parent without custom element registry attribute (scoped registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with declarative shadow root parent without custom element registry attribute adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with declarative shadow root parent with custom element registry attribute (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with declarative shadow root parent with custom element registry attribute (global registry) adopted by new document: registry.initialize is not a function
- Scoped registry element with declarative shadow root parent with custom element registry attribute (scoped registry) adopted by new document: registry.initialize is not a function
- Scoped registry element with imperative shadow root parent (null registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with imperative shadow root parent (global registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with imperative shadow root parent (scoped registry) adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Null registry element with exclusive DocumentFragment parent appended to new document: Cannot read properties of undefined (reading 'body')
- Global registry element with exclusive DocumentFragment parent appended to new document: Cannot read properties of undefined (reading 'body')
- Scoped registry element with exclusive DocumentFragment parent appended to new document: Cannot read properties of undefined (reading 'body')
- Null registry element with exclusive DocumentFragment parent adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Global registry element with exclusive DocumentFragment parent adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
- Scoped registry element with exclusive DocumentFragment parent adopted by new document: Cannot read properties of undefined (reading 'adoptNode')
...
- Document: customElementRegistry of an upgrade candidate after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
- Document: customElementRegistry of an upgrade candidate created with an explicit customElementRegistry argument should return the registry: customElementRegistry.initialize is not a function
...
- Document: customElementRegistry of an unknown element after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
...
- Document: customElementRegistry of document and an upgrade candidate after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
- Document: customElementRegistry of an element created after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
...
- HTMLDocument: customElementRegistry of an upgrade candidate after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
- HTMLDocument: customElementRegistry of an upgrade candidate created with an explicit customElementRegistry argument should return the registry: customElementRegistry.initialize is not a function
...
- HTMLDocument: customElementRegistry of an unknown element after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
...
- HTMLDocument: customElementRegistry of document and an upgrade candidate after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
- HTMLDocument: customElementRegistry of an element created after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
...
- XHTMLDocument: customElementRegistry of an upgrade candidate after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
- XHTMLDocument: customElementRegistry of an upgrade candidate created with an explicit customElementRegistry argument should return the registry: customElementRegistry.initialize is not a function
...
- XHTMLDocument: customElementRegistry of an unknown element after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
...
- XHTMLDocument: customElementRegistry of document and an upgrade candidate after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
- XHTMLDocument: customElementRegistry of an element created after calling CustomElementRegistry.prototype.initialize should return the registry: customElementRegistry.initialize is not a function
