...
- The 'blur' event is not fired on children of HTMLFieldSetElement during moveBefore(): fs.moveBefore is not a function

### dom/nodes/moveBefore/fieldset-child-date-input-blur-event.html

- Neither 'blur' nor 'focusout' is fired on a focused <input type=date> child of HTMLFieldSetElement during moveBefore(): fs.moveBefore is not a function
...
- Don't fire focusin/out when reparenting an element that has focus within: new_parent.moveBefore is not a function
- Don't fire focusin/out when moving to the same parent: old_parent.moveBefore is not a function
- Don't fire focusin and then correct when moving to an inert subtree: promise_test: Unhandled rejection with value: object "TypeError: inert_parent.moveBefore is not a function"
- Don't fire focusin and then correct when moving to a tree that is made inert using style: promise_test: Unhandled rejection with value: object "TypeError: inert_when_not_empty_parent.moveBefore is not a function"

### dom/nodes/moveBefore/focus-preserve.html

- when reparenting an element, don't automatically reset the document focus: new_parent.moveBefore is not a function
- when reparenting a focused element into an inert parent, reset the document focus: promise_test: Unhandled rejection with value: object "TypeError: inert_parent.moveBefore is not a function"
- when reparenting a focused element into a hidden parent, reset the document focus: promise_test: Unhandled rejection with value: object "TypeError: hidden_parent.moveBefore is not a function"
- when reparenting an ancestor of an focused element into a hidden parent, reset the document focus: promise_test: Unhandled rejection with value: object "TypeError: hidden_parent.moveBefore is not a function"
...
- focus-within should be updated when reparenting an element that has focus within: new_parent.moveBefore is not a function
- focus-within should remain the same when moving to the same parent: old_parent.moveBefore is not a function
- :focus-within should be eventually up to date when moving to an inert subtree: promise_test: Unhandled rejection with value: object "TypeError: inert_parent.moveBefore is not a function"
- :focus-within should be eventually up to date when moving to a subtree that would become inert via style: promise_test: Unhandled rejection with value: object "TypeError: inert_when_not_empty_parent.moveBefore is not a function"
...
- when reparenting a modal dialog, the dialog should stay modal: promise_test: Unhandled rejection with value: object "TypeError: document.querySelector(...).moveBefore is not a function"
...
- :focus should be applied to the host and the child node when the focus is moved by mouse click: promise_test: Unhandled rejection with value: object "TypeError: element.getClientRects is not a function"
...
- when shadow host itself is focused, it should match display:none, lose focus then becomes display:block again.: promise_test: Unhandled rejection with value: object "TypeError: window.getComputedStyle is not a function"
- when shadow host with delegatesFocus=true has focused element inside the shadow, it should also match display:none, then lose focus and become display:block again.: promise_test: Unhandled rejection with value: object "TypeError: window.getComputedStyle is not a function"
...
- :focus should be applied to the host and :focus-visible should be applied to the child node when the focus is moved by <tab>: promise_test: Unhandled rejection with value: object "TypeError: element.getClientRects is not a function"
