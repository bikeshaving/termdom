/**
 * Regenerate src/generated/htmltables.ts from webref.
 *
 ...
 *
 * Run: node --experimental-strip-types scripts/generate-html-tables.ts
 */
 ...
 * scripts/generate-html-tables.ts. Do not edit by hand.
 */

import type {ReflectSpec} from "../internal/htmltables.ts";
 ...
 * not here: their rules are prose, and htmltables.ts writes them out.
 */
...
const out = fileURLToPath(
	new URL("../src/generated/htmltables.ts", import.meta.url),
);
