...
async function main(): Promise<void> {
	...
	const lines: string[] = [
		...
		"",
		`- **${supported} supported**, measured.`,
		`- **${results.length - supported} probed and unsupported** -- real gaps.`,
		`- **${naCount} not applicable** to a character grid, by the reasons below.`,
		`- **${unclassified.length} unclassified** -- work left to do.`,
		"",
