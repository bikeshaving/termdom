...
const data = [
  { id: 1, name: "John Doe", email: "john@example.com", status: "Active", score: 95, department: "Engineering" },
  { id: 2, name: "Jane Smith", email: "jane@example.com", status: "Inactive", score: 88, department: "Design" },
  { id: 3, name: "Bob Wilson", email: "bob@example.com", status: "Pending", score: 92, department: "Engineering" },
  { id: 4, name: "Alice Brown", email: "alice@example.com", status: "Active", score: 87, department: "Marketing" },
  { id: 5, name: "Charlie Davis", email: "charlie@example.com", status: "Active", score: 91, department: "Engineering" },
  { id: 6, name: "Diana Prince", email: "diana@example.com", status: "Inactive", score: 96, department: "Design" },
];
  ...
  { 
    ...
    cell: ({ getValue }: any) => {
      ...
      return value === "Active" ? "✓ Active" : 
             value === "Pending" ? "⏳ Pending" : "✗ Inactive";
    }
  },
  { 
    id: "score", 
...
const table = createTable({
  ...
  onSortingChange: (updater: any) => {
    sortingState = typeof updater === 'function' ? updater(sortingState) : updater;
  },
