...
const longText =
	"This is a very long line of text that should be wrapped to multiple lines when it exceeds the maximum width of the container.";
...
container2.appendChild(
	document.createTextNode(
		" and after button some more text that should wrap around nicely.",
	),
);
...
container3.appendChild(
	document.createTextNode("This text should not wrap and may overflow."),
);
...
console.log(
	"2. Green container: Text with button should wrap around inline element",
);
