...
function flexboxDemo() {
  console.log('🎯 Starting TOM Flexbox Layout Demo...\n');
  ...
  // Header section
  const header = tom.createElement('container');
  header.style.flexDirection = 'row';
  header.style.backgroundColor = 'cyan';
  header.style.padding = [1, 1, 1, 1];
  mainContainer.appendChild(header);
  
  const headerTitle = tom.createElement('text');
  headerTitle.textContent = '🚀 TOM Flexbox Demo';
  headerTitle.style.textAlign = 'center';
  headerTitle.style.color = 'black';
  header.appendChild(headerTitle);
  
  const headerSubtitle = tom.createElement('text');
  ...
  for (const item of menuItems) {
    const menuItem = tom.createElement('text');
  ...
  // Main content area
  const mainContent = tom.createElement('container');
  mainContent.style.flexDirection = 'column';
  mainContent.style.backgroundColor = 'white';
  mainContent.style.padding = [1, 2, 1, 2];
  contentArea.appendChild(mainContent);
  
  const contentTitle = tom.createElement('text');
  ...
  const contentText = tom.createElement('text');
  ...
  const featuresContainer = tom.createElement('container');
  ...
  for (const feature of features) {
    const featureCard = tom.createElement('container');
    ...
    const featureTitle = tom.createElement('text');
    featureTitle.textContent = feature.title;
    featureTitle.style.color = 'blue';
    featureTitle.style.textAlign = 'center';
    featureCard.appendChild(featureTitle);
    
    const featureDesc = tom.createElement('text');
