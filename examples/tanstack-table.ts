...
// Sample data
const data = [
  { id: 1, name: "John Doe", email: "john@example.com", status: "Active", score: 95 },
  { id: 2, name: "Jane Smith", email: "jane@example.com", status: "Inactive", score: 88 },
  { id: 3, name: "Bob Wilson", email: "bob@example.com", status: "Pending", score: 92 },
  { id: 4, name: "Alice Brown", email: "alice@example.com", status: "Active", score: 87 },
];
